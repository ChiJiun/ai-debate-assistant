...
3. 到「查詢資料」分頁點「分析辯題並產生搜尋關鍵字」
4. 檢查或修改 LLM 產生的搜尋關鍵字
5. 設定每組關鍵字搜尋結果數量，最少可設為 1，最多 20
6. 選擇資料時間範圍：不限、過去一天、過去一週、過去一個月、過去一年
7. 選擇搜尋深度：快速、標準、進階
8. 點擊「上網查資料（Tavily）」
9. 再點「整理查詢結果」讓 LLM 幫忙整理正反方可用素材
